...
- To use desktop notifications, download `NBTrackr-Notif-v2.3.1.tar.xz`.
- To use the pinned image overlay, download `NBTrackr-imgpin-v2.3.1.tar.xz`.
...
2. Go to the [releases](https://github.com/qMaxXen/NBTrackr/releases/latest) section of this repository and download your preferred version.
   - For desktop notifications, download `NBTrackr-Notif-v2.3.1.tar.xz`
   - For pinned image overlay, download `NBTrackr-imgpin-v2.3.1.tar.xz`
