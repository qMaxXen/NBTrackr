...
- To use desktop notifications, download `NBTrackr-Notif-v2.1.4.tar.xz`.
- To use the pinned image overlay, download `NBTrackr-imgpin-v2.1.4.tar.xz`.
...
2. Go to the [releases](https://github.com/qMaxXen/NBTrackr/releases/tag/v2.1.4) section of this repository and download your preferred version.
- For desktop notifications, download `NBTrackr-Notif-v2.1.4.tar.xz`
- For pinned image overlay, download `NBTrackr-imgpin-v2.1.4.tar.xz`
